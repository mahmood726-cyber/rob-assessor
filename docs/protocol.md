        # Rob Assessor: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/rob-assessor.git

        ## Objective

        RoBAssessor is a guided risk-of-bias assessment tool implementing RoB 2 and ROBINS-I frameworks with domain-specific signalling questions and automated judgement aggregation.
        ...
        - Code: https://github.com/mahmood726-cyber/rob-assessor.git
        - Dashboard: https://mahmood726-cyber.github.io/rob-assessor/
